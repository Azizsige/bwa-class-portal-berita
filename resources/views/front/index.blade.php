        ...
        <div class="card-detail max-w-[1130px] w-full mx-auto flex items-end justify-between pb-10 relative z-20">
          <div class="flex flex-col gap-[10px]">
            ...
            <a href="{{ route('front.details', $article->slug) }}"
              ...
              Str::substr($article->name, 0, 100) }}{{ Str::length($article->name) > 100 ? '...' : '' }}</a>
        ...
        <div class="card-detail w-full flex items-end p-[30px] relative z-20">
          <div class="flex flex-col gap-[10px]">
            ...
            <a href="details.html"
              ...
              Str::substr($entertaiment_featured_articles->name, 0, 50) }}{{
              Str::length($entertaiment_featured_articles->name) > 50 ? '...' : '' }}</a>
          ...
          <a href="{{ route('front.details', $article->slug) }}" class="card py-[2px]">
            <div
              ...
              <div class="flex flex-col justify-center-center gap-[6px]">
                <h3 class="font-bold text-lg leading-[27px]">{{ Str::substr($article->name, 0, 50) }}{{
                  Str::length($article->name) > 50 ? '...' : '' }}</h3>
                <p class="text-sm leading-[21px] text-[#A3A6AE]">{{ $article->created_at->format('M d, Y') }}</p>
              </div>
            </div>
          </a>
      ...
      <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
        ...
        <div class="card-detail w-full flex items-end p-[30px] relative z-20">
          <div class="flex flex-col gap-[10px]">
            ...
            <a href="details.html"
              class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{
              Str::substr($business_featured_articles->name, 0, 50) }}{{
              Str::length($business_featured_articles->name) > 50 ? '...' : '' }}</a>
      ...
      <div class="featured-news-card relative w-full h-[424px] flex flex-1 rounded-[20px] overflow-hidden">
        ...
        <div class="card-detail w-full flex items-end p-[30px] relative z-20">
          <div class="flex flex-col gap-[10px]">
            ...
            <a href="details.html"
              class="font-bold text-[30px] leading-[36px] text-white hover:underline transition-all duration-300">{{
              Str::substr($automotive_featured_articles->name, 0, 50) }}{{
              Str::length($automotive_featured_articles->name) > 50 ? '...' : '' }}</a>
